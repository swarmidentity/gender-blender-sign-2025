...
uint8_t BIPOC_PRIDE_BLACK_VALUE_BASE = 25; 
uint8_t BIPOC_PRIDE_DARK_BROWN_VALUE_BASE = 75;
uint8_t BIPOC_PRIDE_MEDIUM_BROWN_VALUE_BASE = 125;
uint8_t BIPOC_PRIDE_LIGHT_BROWN_VALUE_BASE = 150;
uint8_t BIPOC_PRIDE_BLACK_VALUE_RANGE = 50;
uint8_t BIPOC_PRIDE_DARK_BROWN_VALUE_RANGE = 75;
uint8_t BIPOC_PRIDE_MEDIUM_BROWN_VALUE_RANGE = 75;
uint8_t BIPOC_PRIDE_LIGHT_BROWN_VALUE_RANGE = 50;
uint16_t BIPOC_PRIDE_DARK_HUE = (65536 * 28 ) / 360; // Dark Brown
uint16_t BIPOC_PRIDE_LIGHT_HUE = (65536 * 25 ) / 360; // Medium Brown
uint16_t BIPOC_PRIDE_DARK_SATURATION = 255;
uint16_t BIPOC_PRIDE_LIGHT_SATURATION = 127;
